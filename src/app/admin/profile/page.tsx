      ...
      <div className="max-w-2xl mx-auto">
        <div className="mb-12">
          <div className="flex items-center gap-4 mb-2">
            ...
            <div>
              <h1 className="text-3xl font-black text-white tracking-tight">Admin Profile</h1>
              <p className="text-neutral-400 font-medium">Manage your administrative account settings</p>
            </div>
          </div>
        </div>

        <div className="bg-neutral-900/50 border border-white/5 rounded-3xl p-8 backdrop-blur-xl">
          <ProfileSettingsForm backUrl="/admin" />
        </div>
      </div>
    </div>
  );
