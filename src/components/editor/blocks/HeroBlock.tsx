...
import { PreviewContext, BlockProps, ChildBlockWrapper, DropZoneStrip, SortableBlockGroup, getBackgroundStyles, BackgroundOverlay, getTextStyles, SectionChildBlocks } from "./shared";
...
export function HeroBlock({ block }: BlockProps) {
    ...
    const sectionMinHeight = layout === "fullscreen" ? "100dvh" : (p.minHeight as string) || "60dvh";
    ...
    return (
        ...
        `}</style>
            ...
            >
                ...
                >
                    <SectionChildBlocks block={block} isSelected={isSelected} topBlocks={topBlocks} top prefix="hero" stripColor="#ffffff" />
                    <SectionChildBlocks block={block} isSelected={isSelected} childBlocks={childBlocks} bottom prefix="hero" stripColor="#ffffff" emptyLabel="Drag blocks here to build your Hero" />
                </div>
            </section>
        </>
    );
