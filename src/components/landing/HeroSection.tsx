...
import { ArrowRightIcon, PlayIcon, SparklesIcon, StarIcon } from "@heroicons/react/24/outline";
      ...
      <Container className="hero-inner" style={{ paddingTop: 120, paddingBottom: 80, position: "relative", zIndex: 5 }}>
        <div style={{ maxWidth: 820, margin: "0 auto", textAlign: "center" }}>
          ...
          <div className="animate-fade-in-up" style={{
            ...
            <SparklesIcon style={{ width: 13, height: 13, color: "#f9a8d4" }} />
          ...
          >
            ...
            >
              <div style={{
                ...
                <PlayIcon style={{ width: 11, height: 11, color: "white", marginLeft: 2 }} />
              </div>
              Watch demo
            </button>
          </div>
